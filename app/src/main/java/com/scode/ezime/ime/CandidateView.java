...
public class CandidateView extends View {
    ...
    public CandidateView(Context context, AttributeSet attrs) {
        ...
        mActiveCellDrawable = r.getDrawable(R.drawable.item_select);
        ...
        mFootnotePaint.setColor(r.getColor(R.color.bg_black_3));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(getDefaultSize((int) (getSuggestedMinimumWidth() * Settings.getSizeRatioPercent() * 0.6),
                widthMeasureSpec), getDefaultSize((int) (getSuggestedMinimumHeight() * Settings.getSizeRatioPercent() * 0.6),
                heightMeasureSpec));
    ...
    private void onSizeChanged() {
        ...
        mImeCandidateTextSize = (int) (textSize*0.8f);
...
//        mSeparatorDrawable.draw(canvas);
    ...
    private void showBalloon(int candPos, boolean delayedShow) {
        ...
        mBalloonHint.setBalloonConfig(mDecInfo.mCandidatesList
                        .get(mDecInfo.mPageStart.get(mPageNo) + candPos), ((int) (36 * Settings.getSizeRatioPercent())), true,
                mImeCandidateColor, desired_width, desired_height);
        mLocationTmp = new int[]{this.getLeft()+40,this.getTop()};
...
//        mHintPositionToInputView[0] = mLocationTmp[0];
//        mHintPositionToInputView[1] = mLocationTmp[1];
