...
public class SoftKeyboardView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Loger.i("SoftKeyboardView onMeasure");
        int measuredWidth = MeasureSpec.getSize(widthMeasureSpec);
        int measuredHeight = MeasureSpec.getSize(heightMeasureSpec);
        int measuredWMode = MeasureSpec.getSize(heightMeasureSpec);
        int measuredHMode = MeasureSpec.getSize(heightMeasureSpec);
        measuredWidth = Environment.getInstance().getSKBWidth();
        measuredHeight = Environment.getInstance().getSKBHeight();
        measuredWidth += getPaddingLeft() + getPaddingRight();
        measuredHeight += getPaddingTop() + getPaddingBottom();
        Loger.i("SoftKeyboardView W" + measuredWidth + " H" + measuredHeight);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Environment env = Environment.getInstance();
        mNormalKeyTextSize = (int) (env.getKeyTextSize(false) * Settings.getSizeRatioPercent());
        mFunctionKeyTextSize = (int) (env.getKeyTextSize(true) * Settings.getSizeRatioPercent());
